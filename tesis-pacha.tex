...
\NormalTok{  fit\_counterfactual\_app1\_2 }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(}
\NormalTok{    trade\_1 }\SpecialCharTok{\textasciitilde{}} \DecValTok{0} \SpecialCharTok{+}\NormalTok{ exporter }\SpecialCharTok{+}\NormalTok{ importer }\SpecialCharTok{+} \FunctionTok{offset}\NormalTok{(log\_tij\_cfl)}
\NormalTok{    ...}
\NormalTok{  )}
\NormalTok{  ...}
...
\NormalTok{  ch2\_application1 }\OtherTok{\textless{}{-}}\NormalTok{ ch2\_application1 }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{tradehat\_1 =} \FunctionTok{predict}\NormalTok{(fit\_counterfactual\_app1\_2, }
\NormalTok{                                ch2\_application1, }\StringTok{"response"}\NormalTok{))}
\NormalTok{  ...}
