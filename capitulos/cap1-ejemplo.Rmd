...
Por completitud incluyo una cita en Bibtex: @bock2010stats contiene la ecuación de la media ponderada.

También podríamos decir "la definición de media ponderada es ... [@bock2010stats]".
